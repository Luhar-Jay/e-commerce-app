...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="md:w-64 w-36  h-fit md:h-fit m-2   md:m-10 md:mt-10 border rounded-lg ">
      <div className="bg-slate-200    rounded-lg border hover:border-gray-500 shadow-md p-2">
        <div className="flex items-center md:mx-0 mx-10">
          <img
            alt="img"
            src={image}
            className="md:w-64 md:h-64 w-12 h-12 hover:scale-90 rounded-lg text-center flex items-center"
          />
        </div>
